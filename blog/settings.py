...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DBNAME', 'xxx').strip(),  # Database name
        'USER': os.environ.get('POSTGRES_USERNAME', 'xxx').strip(),  # DB user
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'xxx').strip(),  # DB password
        'HOST': os.environ.get('POSTGRES_HOST', 'localhost').strip(),  # DB host
        'PORT': os.environ.get('POSTGRES_PORT', '5432').strip(),  # DB port
    }
}
